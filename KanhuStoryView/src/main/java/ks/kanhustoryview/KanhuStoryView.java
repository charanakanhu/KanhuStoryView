...
public class KanhuStoryView extends View {
    ...
    private ArrayList<KanhuStoryModel> storyImageUris;
    ...
    public KanhuStoryView(Context context) {
        super(context);
        init(context);
        setDefaults();
    }
    ...
    private void init(Context context) {
        kanhuPreference = new KanhuPreference(context);
    ...
    public KanhuStoryView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    ...
    public void resetStoryVisits() {
        kanhuPreference.clearStoryPreferences();
    }

    public void setImageUris(ArrayList<KanhuStoryModel> imageUris) {
    ...
    private void navigateToStoryPlayerPage() {
        if (mContext == null) {
            ...
            Intent intent = new Intent(mContext, KanhuPlayer.class);
            intent.putParcelableArrayListExtra(KanhuPlayer.STORY_IMAGE_KEY, storyImageUris);
    ...
    private int getIndicatorColor(int index) {
        return kanhuPreference.isStoryVisited(storyImageUris.get(index).imageUri) ? mVisistedIndicatorColor : mPendingIndicatorColor;
    }
